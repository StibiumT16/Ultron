...
def gen_query_instance(id_to_token, token_to_id, all_docid, encoded_docid):
    ...
    with open(args.qrels_path) as fin,  open(args.output_path, "w") as fout:
        for line in tqdm(fin):
            ...
            fout.write(json.dumps(evaluation_instance, ensure_ascii=False)+"\n")

if __name__ == "__main__":
    print("generate evaluate instance")
